...
def set_dc(ser, settings):
    if len(settings) != 1:
        raise ValueError("set_dc needs 1 values")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p','--set_dc', nargs=1, metavar=('P'), type=float, help='Set duty cycle: 0 - 6250')
